...
|---|----------|-------|------|-------------|
| 1 | PRICING (#e67e22) | Decoy Effect (Asymmetric Dominance) | [applied-game-theory-behavioral-design/01-decoy-effect.md](applied-game-theory-behavioral-design/01-decoy-effect.md) | Movie theater popcorn: Small $3.99, Medium $7.99, Large $8.99. Nobody buys the medium — it exists to make large look like a steal. Without the medium, you'd compare small vs large ($5 gap). With the medium, you compare medium vs large ($1 gap) — and large wins every time. The decoy reframes which comparison you make. |
| 2 | BEHAVIORAL LOOPS (#8e44ad) | Streaks, Coins & Variable Rewards | [applied-game-theory-behavioral-design/02-streaks-coins-variable-rewards.md](applied-game-theory-behavioral-design/02-streaks-coins-variable-rewards.md) | Duolingo streaks, Snapchat streaks, daily login bonuses. Slot machine reward schedules inside learning apps. Loss aversion weaponized as engagement. |
| 3 | GAME THEORY (#27ae60) | Auctions & Bidding Mechanics | [applied-game-theory-behavioral-design/03-auctions-bidding-mechanics.md](applied-game-theory-behavioral-design/03-auctions-bidding-mechanics.md) | Google Ads second-price auctions. eBay proxy bidding. Why the mechanism forces you to be honest — and why that's profitable for the platform. |
| 4 | SOCIAL PRESSURE (#e74c3c) | Leaderboards & Social Proof | [applied-game-theory-behavioral-design/04-leaderboards-social-proof.md](applied-game-theory-behavioral-design/04-leaderboards-social-proof.md) | Ranked lists that make you compete against strangers. "X people are viewing this right now." Manufactured scarcity and urgency that exists only in the UI. |
| 5 | PRICING (#2980b9) | Subscription & Commitment Traps | [applied-game-theory-behavioral-design/05-subscription-commitment-traps.md](applied-game-theory-behavioral-design/05-subscription-commitment-traps.md) | Annual vs monthly pricing. Free trials that auto-convert. The math of why "first month free" is profitable even when 40% cancel immediately. |
| 6 | PSYCHOLOGY (#e67e22) | Charm Pricing & Number Psychology | [applied-game-theory-behavioral-design/06-charm-pricing-number-psychology.md](applied-game-theory-behavioral-design/06-charm-pricing-number-psychology.md) | $19.99, $97, $199. Left-digit effect. Why the brain reads $19.99 as "nineteen" not "twenty." How pricing tiers are built around cognitive thresholds, not cost. |
