...
Statistical preconditions behind common ML algorithms and when they break.
...
- **Template default:** 05-two-col-catalog-clean (single-table variant with tag pills; 42/58 split)
