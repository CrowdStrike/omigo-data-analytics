...
Classic tests: what they assume, when they fail, what to use instead.
...
- **Template default:** 06-sectioned-cards-callout (rich callout kit: `.failure`, `.alt-note`, `.real-world`, `.decision-table`)
