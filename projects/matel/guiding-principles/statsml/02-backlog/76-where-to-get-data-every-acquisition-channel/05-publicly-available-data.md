...
|---|----------|-------|------|-------------|--------|
| 1 | LEGAL MANDATE | Public-by-Legal-Mandate Records | [05-publicly-available-data/01-public-by-legal-mandate-records.md](05-publicly-available-data/01-public-by-legal-mandate-records.md) | Deeds, land registries, court records, business filings, voter rolls, licenses — public because openness is what makes the legal function work. Nordic countries even publish individual tax figures. | property, courts, registries |
| 2 | GOVERNMENT | Government Statistical & Open-Data Portals | [05-publicly-available-data/02-government-statistical-and-open-data-portals.md](05-publicly-available-data/02-government-statistical-and-open-data-portals.md) | Census bureaus, national statistics offices, economic series, weather, health, crime — governments publishing aggregates and portals by policy, worldwide. | census, FRED / World Bank, open portals |
| 3 | BROADCAST | Live Sensor & Broadcast Feeds | [05-publicly-available-data/03-live-sensor-and-broadcast-feeds.md](05-publicly-available-data/03-live-sensor-and-broadcast-feeds.md) | Aircraft, ships, transit, earthquakes, webcams — public because the signal is literally in the air, and anyone with an antenna or an API key can listen. | ADS-B, AIS, GTFS |
| 4 | IMAGERY | Imagery & Mapping | [05-publicly-available-data/04-imagery-and-mapping.md](05-publicly-available-data/04-imagery-and-mapping.md) | Street View and its global equivalents, free satellite programs like Landsat and Sentinel, OpenStreetMap, crowdsourced street-level photos — the surface of the planet, browsable. | street view, satellite, OSM |
| 5 | MARKET | Corporate & Market Data Exhaust | [05-publicly-available-data/05-corporate-and-market-data-exhaust.md](05-publicly-available-data/05-corporate-and-market-data-exhaust.md) | Stock prices and filings, crypto ledgers public by design, job postings, WHOIS and certificate transparency logs, prices and reviews — commerce leaves a publicly browsable trail. | filings, blockchains, cert logs |
| 6 | VOLUNTEERED | User-Generated & Crowdsourced Data | [05-publicly-available-data/06-user-generated-and-crowdsourced-data.md](05-publicly-available-data/06-user-generated-and-crowdsourced-data.md) | Public social posts, Wikipedia, reviews, public code activity, fitness heatmaps, wardriving maps — volunteered by individuals, aggregated into datasets nobody individually consented to. | social, Strava heatmap, WiGLE |
| 7 | RESEARCH | Scientific & Research Corpora | [05-publicly-available-data/07-scientific-and-research-corpora.md](05-publicly-available-data/07-scientific-and-research-corpora.md) | Paper archives, genomic databases, public DNA matching, web crawls, astronomy surveys, the archived web — published to advance science, reused far beyond it. | arXiv / PubMed, GenBank, Common Crawl |
