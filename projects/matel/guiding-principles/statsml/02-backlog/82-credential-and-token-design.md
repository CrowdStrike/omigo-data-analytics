...
### 1. API Tokens & Keys — [82-credential-and-token-design/01-api-tokens-and-keys.md](82-credential-and-token-design/01-api-tokens-and-keys.md)
...
### 2. Structured Signed Tokens — [82-credential-and-token-design/02-structured-signed-tokens.md](82-credential-and-token-design/02-structured-signed-tokens.md)
...
### 3. Session Cookies & Anti-Replay Design — [82-credential-and-token-design/03-session-cookies-and-anti-replay-design.md](82-credential-and-token-design/03-session-cookies-and-anti-replay-design.md)
...
### 4. Revocation & Lifetime Semantics — [82-credential-and-token-design/04-revocation-and-lifetime-semantics.md](82-credential-and-token-design/04-revocation-and-lifetime-semantics.md)
...
### 5. Password Composition Rules — [82-credential-and-token-design/05-password-composition-rules.md](82-credential-and-token-design/05-password-composition-rules.md)
...
### 6. Password Storage Design — [82-credential-and-token-design/06-password-storage-design.md](82-credential-and-token-design/06-password-storage-design.md)
...
### 7. PINs & Numeric Secrets — [82-credential-and-token-design/07-pins-and-numeric-secrets.md](82-credential-and-token-design/07-pins-and-numeric-secrets.md)
...
### 8. Security Questions & KBA — [82-credential-and-token-design/08-security-questions-and-kba.md](82-credential-and-token-design/08-security-questions-and-kba.md)
...
### 9. Recovery Credentials — [82-credential-and-token-design/09-recovery-credentials.md](82-credential-and-token-design/09-recovery-credentials.md)
