...
### 1. Postal Mail Interception & Check Washing — POSTAL (`#8e44ad`) — [86-man-in-the-middle-attacks-across-sectors/01-postal-mail-interception-and-check-washing.md](86-man-in-the-middle-attacks-across-sectors/01-postal-mail-interception-and-check-washing.md)
...
### 2. ATM & Gas Pump Card Skimmers — BANKING (`#e74c3c`) — [86-man-in-the-middle-attacks-across-sectors/02-atm-and-gas-pump-card-skimmers.md](86-man-in-the-middle-attacks-across-sectors/02-atm-and-gas-pump-card-skimmers.md)
...
### 3. Fake Public Wi-Fi Hotspots — PUBLIC SPACES (`#2980b9`) — [86-man-in-the-middle-attacks-across-sectors/03-fake-public-wi-fi-hotspots.md](86-man-in-the-middle-attacks-across-sectors/03-fake-public-wi-fi-hotspots.md)
...
### 4. Fake Cell Towers — TELECOM (`#1a5276`) — [86-man-in-the-middle-attacks-across-sectors/04-fake-cell-towers.md](86-man-in-the-middle-attacks-across-sectors/04-fake-cell-towers.md)
...
### 5. Invoice & Wire Fraud in Email Threads — REAL ESTATE (`#e67e22`) — [86-man-in-the-middle-attacks-across-sectors/05-invoice-and-wire-fraud-in-email-threads.md](86-man-in-the-middle-attacks-across-sectors/05-invoice-and-wire-fraud-in-email-threads.md)
...
### 6. Man-in-the-Browser Banking Trojans — ONLINE BANKING (`#e74c3c`) — [86-man-in-the-middle-attacks-across-sectors/06-man-in-the-browser-banking-trojans.md](86-man-in-the-middle-attacks-across-sectors/06-man-in-the-browser-banking-trojans.md)
...
### 7. QR Code Sticker Swaps — PAYMENTS (`#27ae60`) — [86-man-in-the-middle-attacks-across-sectors/07-qr-code-sticker-swaps.md](86-man-in-the-middle-attacks-across-sectors/07-qr-code-sticker-swaps.md)
...
### 8. Car Key Relay Attacks — AUTOMOTIVE (`#1a5276`) — [86-man-in-the-middle-attacks-across-sectors/08-car-key-relay-attacks.md](86-man-in-the-middle-attacks-across-sectors/08-car-key-relay-attacks.md)
...
### 9. Home Router DNS Hijacking — HOME INTERNET (`#2980b9`) — [86-man-in-the-middle-attacks-across-sectors/09-home-router-dns-hijacking.md](86-man-in-the-middle-attacks-across-sectors/09-home-router-dns-hijacking.md)
...
### 10. Corporate HTTPS Inspection — WORKPLACE (`#8e44ad`) — [86-man-in-the-middle-attacks-across-sectors/10-corporate-https-inspection.md](86-man-in-the-middle-attacks-across-sectors/10-corporate-https-inspection.md)
