...
Diagram: MAP — two machines count locally, stacked vertically in the narrow frame.

- **Title (bold 15px ink, top center):** "Map: Count Your Own Pile"
- **Machine A box** at (25,38), 260×116: fill `rgba(0,131,0,0.08)`, stroke green `#008300`. Centered at x=155: bold green 13px "Machine A"; italic 12px dark text lines `"the cat sat"` and `"the dog ran"`; bold violet 12px lines "the:2 cat:1 sat:1" / "dog:1 ran:1". Small gray downward arrow from (155,101) to (155,114) between sentences and counts.
- **Machine B box** at (25,164), 260×92: fill `rgba(42,120,214,0.08)`, stroke blue `#2a78d6`. Centered at x=155: bold blue 13px "Machine B"; italic 12px `"the cat ran"`; bold violet 12px "the:1 cat:1 ran:1". Gray arrow (155,209)→(155,221).
- **Annotations (centered):** bold magenta 13px two lines at y=278/295: "neither machine has seen" / "the other's sentences"; gray 12px two lines at y=316/333: "map output: (word, count) pairs," / "one small table per machine".
...
- **Column headers (bold 12px, y=54):** aqua `#199e70` "shuffle: pile per word" at x=106; orange `#d95926` "reduce" at x=232.
...
- Each row: word right-aligned bold dark 13px at x=50; pile box (56,y) 100×25 fill `rgba(25,158,112,0.10)` stroke aqua with pile text centered; gray arrow to total box (200,y) 64×25 fill `rgba(217,89,38,0.12)` stroke orange with bold orange total.
- **Bottom annotations (centered):** bold magenta 13px at y=296: "totals: 3+2+2+1+1 = 9 words"; gray 12px at y=315: "matches the 9 words we started with".
