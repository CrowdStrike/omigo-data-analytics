...
- **Title (bold 14px, `#1a5276`, top center):** "Naive Bayes: count and multiply"
- **Rate table** (x0=20, y0=64, column widths 70/100/100, row height 24): header row bold 12px — "word" in ink `#1a5276`, "spam" in orange `#d95926`, "legit" in blue `#2a78d6`; rows "\"free\"" → "14/16 = .875" / "2/16 = .125" and "\"meeting\"" → "2/16 = .125" / "14/16 = .875" (cells 12px `#333`, zebra `#f4f7fa`/white, border `#c9d4de`).
- **Priors line (12px `#444`, centered, y=136):** "priors: 5 spam, 5 legit out of 10 → .5 each"
- **New email box:** dashed magenta rectangle (`#d55181`, dash 5/4) 250×34 centered at x=w/2, y=152; bold 13px magenta text centered inside: "new email: \"free free meeting\""
- **Score lines (bold 13px, centered, formula and result on two lines each):** orange `#d95926` at y=212/230: "spam: .5 × .875 × .875 × .125" / "≈ .048"; blue `#2a78d6` at y=256/274: "legit: .5 × .125 × .125 × .875" / "≈ .007"
- **Verdict (bold 13px green `#008300`, centered, y=302):** "spam ≈ 7× more likely → SPAM"
- **Caption (12px `#6b7280`, centered, y=326):** "illustrative counts, 10 training emails"

### Visualization (canvas `c2b`, 310×340)

Scatter of the 10 emails with the logistic-regression boundary line.

- **Title (bold 14px, `#1a5276`, top center):** "Logistic regression: just the line"
- **Axes:** x = "free" count, y = "meeting" count, both mapped over −0.5..5.2; padding top 46 / bottom 66 / left 46 / right 12; L-shaped gray `#999` axis.
- **Points:** the 10 emails, 6px dots — spam orange `#d95926`, legit blue `#2a78d6`.
- **Boundary:** dashed violet diagonal (`#4a3aa7`, dash 6/4, width 2.5) along meeting=free from (−0.5,−0.5) to (5.2,5.2); bold 12px violet right-aligned two-line label at x=w−8, y at data 2.3 / 1.85: "free > meeting" / "→ spam".
- **In-plot labels (bold 12px):** orange "spam" at (4.6, 0.4), blue "legit" at (2.1, 3.9).
- **Caption (bold 12px green `#008300`, centered below axis at y=300):** "same verdict, no class model"
- **Axis caption (12px `#444`, centered, y=322):** "x = \"free\" count, y = \"meeting\" count"
