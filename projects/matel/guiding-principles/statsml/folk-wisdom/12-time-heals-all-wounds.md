...
**HTML title tag:** Time heals all wounds — Folk Wisdom Dissected

**Subtitle:** Folk wisdom dissected into its component fallacies — what the saying hides and why it feels true anyway.

## Saying card

**Why-believed line:** Why people believe it: emotional intensity does decrease over time for many experiences, giving the illusion of universal healing.

### Flaw table

| # | Fallacy | How it hides |
|---|---------|--------------|
| 1 | Universal quantifier fallacy | "All" admits no exceptions. A single chronic condition disproves it. |
| 2 | Survivorship bias | People who healed talk about it. People stuck in chronic pain/grief are less visible. |
| 3 | Unfalsifiable | "Heals" is undefined (fully? partially? "enough"?). Any improvement counts; any remaining damage is dismissed as "not enough time yet." |
| 4 | Confuses correlation with mechanism | Time doesn't heal — interventions that happen during time do. Time is the container, not the treatment. |
| 5 | Ignores compounding | Some wounds get worse over time without intervention (infections, untreated mental health, toxic relationships). |

### Undefined terms (orange callout)

**Undefined terms:** "time" (how much?), "heals" (fully? functionally?), "all" (really all?), "wounds" (physical? emotional? social?)

### Counterexamples (green callout)

**Counterexamples:**

- Chronic PTSD — can persist or worsen without treatment regardless of elapsed time
- Untreated infections — time makes them worse, not better
- Grief that transforms into complicated grief — time alone doesn't resolve it
