...
class LogScaleSearch:
    ...
    def __execute_normal_query__(self, query, start_time_millis, end_time_millis, accepted_cols, excluded_cols, attempts_remaining, limit, num_par_on_limit, dmsg = ""):
        ...
        # try:
        # submit job
        utils.debug("{}: Query: {}, Start Time: {}, End Time: {}".format(dmsg, query, timefuncs.utctimestamp_millis_to_datetime_str(start_time_millis),
            timefuncs.utctimestamp_millis_to_datetime_str(end_time_millis)))
        ...
        utils.debug("{}: LogScale Job submitted: {}, start_time: {}, end_time: {}".format(utils.max_dmsg_str(dmsg), job_id_trim,
