...
class TSV:
    ...
    def replace_str(self, col, old_str, new_str, inherit_message = ""):
        inherit_message2 = inherit_message + ": replace_str" if (len(inherit_message) > 0) else "replace_str"
        return self.exclude_filter([col], lambda x: x.replace(old_str, new_str), inherit_message = inherit_message2)
